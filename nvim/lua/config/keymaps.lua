...
vim.keymap.set("x", "<leader>p", [["_dP]], { desc = "Replace selected text without affecting the unnamed register" })
...
vim.keymap.set(
	...
	"<leader>p",
	[["_dP]],
	{ desc = "Replaces the selected text with the default register content without affecting the unnamed register." }
)
